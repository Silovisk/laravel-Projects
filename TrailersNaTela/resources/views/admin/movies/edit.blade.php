    ...
    <div class="card">
        <div class="card-body">
            <div class="container-fluid">
                <form action="{{ route('movies.update', ['movie' => $movie->id]) }}" id="formEditMovie" class="global-form"
                    ...
                    <div class="row">
                        <div class="col-md-5">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="title" name="title"
                                    placeholder="Titulo do Filme" value="{{ $movie->title ?? old('title') }}" required>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-floating mb-3">
                                <select class="form-control select2MovieCategory" id="category" name="category[]"
                                    ...
                                    @foreach ($categories as $category)
                                        <option value="{{ $category->id }}"
                                            {{ in_array($category->id, old('category', $movieCategoryIds)) ? 'selected' : '' }}>
                                            {{ $category->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-floating mb-3">
                                <div class="form-floating mb-3">
                                    <select class="form-select" id="director_id" name="director_id" required>
                                        <option value="" disabled>Selecione um diretor</option>
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="duration" name="duration"
                                    placeholder="Duração do Filme" value="{{ $movie->duration ?? old('duration') }}"
                                    required>
                        ...
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="file" class="form-control" id="path_poster" name="path_poster"
                                    placeholder="Poster do Filme" value="{{ $movie->path_poster ?? old('path_poster') }}">
                                <label for="path_poster">Poster</label>
                                @if ($movie->path_poster)
                                    <p>Current file: {{ $movie->path_poster }}</p>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-floating mb-3">
                                <input type="text" class="form-control" id="path_trailer" name="path_trailer"
                                    ...
                                    value="{{ $movie->path_trailer ?? old('path_trailer') }}" required>
                        ...
                        <div class="col-md-12">
                            <div class="form-floating mb-3">
                                <textarea type="text" class="form-control" id="synopsis" name="synopsis" placeholder="Nome do Filme"
                                    value="{{ $movie->synopsis ?? old('synopsis') }}" required>{{ $movie->synopsis ?? old('synopsis') }}</textarea>
